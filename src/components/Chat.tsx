...
export default function Chat() {
  ...
  return (
    <div className='min-h-screen bg-white flex flex-col p-4 md:p-6 max-w-screen-md mx-auto relative'>
      {/* Header */}
      ...
      <div className='bg-white rounded-xl shadow-md p-3 mb-4'>
        <div className='flex items-center gap-2'>
          ...
          <button
            type='button'
            className='flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center hover:bg-blue-100 transition-colors'
